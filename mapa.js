document.addEventListener("DOMContentLoaded", () => {
            ...
            actors: [
                {
                    ...
                    description:
                        "Órgão executivo municipal, responsável pela administração pública.",
                },
                {
                    ...
                    link: "#",
                    description:
                        "Promove o desenvolvimento econômico e social do município.",
                },
                {
                    ...
                    link: "#",
                    description:
                        "Oferece linhas de crédito e apoio para empresas locais.",
                },
            ],
        },
        {
            ...
            actors: [
                {
                    ...
                    description:
                        "Universidade estadual com cursos de graduação e pós-graduação.",
                },
                {
                    ...
                    description:
                        "Instituto Federal que oferece cursos técnicos, superiores e de extensão.",
                },
                {
                    name: "SENAI",
                    ...
                    description:
                        "Focado na formação profissional para a indústria.",
                },
            ],
        },
        {
            ...
            actors: [
                {
                    ...
                    link: "#",
                    description:
                        "Instituições financeiras que apoiam projetos de desenvolvimento.",
                },
                {
                    ...
                    link: "#",
                    description:
                        "Pessoas físicas que investem em startups em troca de participação.",
                },
                {
                    ...
                    link: "#",
                    description:
                        "Pequenos empréstimos para empreendedores e pequenos negócios.",
                },
            ],
        },
        {
            ...
            actors: [
                {
                    ...
                    link: "#",
                    description:
                        "Empresas de base tecnológica focadas em soluções para o agronegócio.",
                },
                {
                    ...
                    description:
                        "Grande empresa do setor de mineração com operação na cidade.",
                },
                {
                    ...
                    link: "#",
                    description:
                        "Lojas e serviços que utilizam tecnologia para inovar.",
                },
            ],
        },
        {
            ...
            actors: [
                {
                    ...
                    description:
                        "Representa e apoia os empresários e comerciantes locais.",
                },
                {
                    name: "Sebrae",
                    ...
                    description:
                        "Apoio às micro e pequenas empresas, fomentando o empreendedorismo.",
                },
                {
                    ...
                    link: "#",
                    description:
                        "Escritórios compartilhados que promovem networking e colaboração.",
                },
            ],
        },
        {
            ...
            actors: [
                {
                    ...
                    link: "#",
                    description:
                        "Encontros informais para profissionais de tecnologia trocarem ideias.",
                },
                {
                    ...
                    link: "#",
                    description:
                        "Feiras, palestras e competições para fomentar novos negócios.",
                },
                {
                    ...
                    link: "#",
                    description:
                        "Comunidades online e presenciais para desenvolvedores de software.",
                },
            ],
        },
    ];
    ...
    // Função para exibir os atores (ATUALIZADA)
    const displayActors = (category) => {
        actorsList.innerHTML = "";

        let actorsToShow = category
            ? category.actors
            : ecosystemData.flatMap((cat) => cat.actors);

        actorsDisplay.querySelector("h3").innerText = category
            ? `Atores de: ${category.level}`
            : "Todos os Atores do Ecossistema";
        actorsDisplay.querySelector("p").style.display = "none";
    ...
    // Configuração do Gráfico (sem alterações)
        ...
        options: {
            ...
            onClick: (event, elements) => {
                if (elements.length > 0) {
                    displayActors(ecosystemData[elements[0].index]);
                }
            },
        },
    });

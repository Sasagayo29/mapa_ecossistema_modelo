...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const actorsList = document.getElementById(
        "actors-list"
    ) as HTMLUListElement | null;
    const actorsDisplay = document.getElementById(
        "actors-display"
    ...
    if (
        ...
        console.error(
            "Erro: Um ou mais elementos essenciais do DOM não foram encontrados."
        );
        return;
    }
    ...
    const displayActors = (category: EcosystemCategory | null): void => {
        actorsList.innerHTML = ""; // Limpa a lista

        const actorsToShow: Actor[] = category
            ? category.actors
